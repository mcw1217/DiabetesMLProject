...
def survey_ans():
    ...
    survey_content = f"{age},{gender},{a},{b},{c},{d},{e},{f},{g},{h},{i},{j},{k},{l},{m},{n}"
    ...
    return redirect(url_for('booking', msg=msg, survey_content=survey_content,pre=y_pre[0]))
...
def booking():
    if 'loggedin' in session:
        ...
        return render_template('booking.html',msg=msg,survey_content=survey_content,pre=pre)
